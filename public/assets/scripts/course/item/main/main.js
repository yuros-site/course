(() => {
  ...
  darkmode && darkproc(), console.log("Module : deffers main course javascript engine loaded");
  var main_tabs = () => {
  ...
  var part_tabs = () => {
    ...
    let e = document.getElementById("part"), n = e.querySelectorAll(".dropdown"), t = Array.prototype.slice.call(n), s = e.querySelectorAll(".dropboxs"), o = Array.prototype.slice.call(s);
    t.forEach((e2) => {
      e2.addEventListener("click", () => {
        let n2 = e2.getAttribute("data-target");
        e2.classList.contains("open") ? (e2.classList.remove("open"), document.getElementById(n2).classList.remove("open")) : (t.forEach((e3) => {
          e3.classList.remove("open");
        }), o.forEach((e3) => {
          e3.classList.remove("open");
        }), e2.classList.add("open"), document.getElementById(n2).classList.add("open"));
  ...
  var task_tabs = () => {
    if (window.innerWidth > 1024) return;
    let e = document.getElementById("task"), n = e.querySelectorAll(".dropdown"), t = Array.prototype.slice.call(n), s = e.querySelectorAll(".dropboxs"), o = Array.prototype.slice.call(s);
    t.forEach((e2) => {
      e2.addEventListener("click", () => {
        let n2 = e2.getAttribute("data-target");
        e2.classList.contains("open") ? (e2.classList.remove("open"), document.getElementById(n2).classList.remove("open")) : (t.forEach((e3) => {
  ...
  window.addEventListener("load", () => {
    main_tabs(), node_tabs(), part_tabs(), task_tabs();
  });
})();
