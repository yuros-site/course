(() => {
  ...
  }), console.log(" Script : deffers based script loaded"), console.log("Format: Youtube footer script loaded"), window.addEventListener("load", () => {
    let e = document.getElementById("format-vimeo"), t = () => {
      let t2 = e.querySelector("#covers"), n = e.querySelector("#player"), s = e.querySelector("#iframe");
      t2.addEventListener("click", () => {
        t2.classList.add("hide"), n.classList.remove("hide"), s.src = n.getAttribute("data-uri");
      });
    };
    t();
