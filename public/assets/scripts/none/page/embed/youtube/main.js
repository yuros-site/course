(() => {
  ...
  }), console.log(" Script : deffers based script loaded"), console.log("Format: Youtube footer script loaded");
  var starter = document.getElementById("format-youtube");
  var webi_youtube_format = () => {
    let e = starter.querySelector("#covers"), t = starter.querySelector("#player"), n = starter.querySelector("#iframe");
    e.addEventListener("click", () => {
      e.classList.add("hide"), t.classList.remove("hide"), n.src = t.getAttribute("data-uri");
    });
  };
  webi_youtube_format(), console.log("Parted : main | shift : deffered | scope : navs | source : default | type : script | status : loaded");
  ...
  darkmode && darkproc(), console.log("defers page script loaded");
})();
